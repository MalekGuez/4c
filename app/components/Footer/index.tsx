  ...
  return (
    <>
      <div className={styles.discordBar}>
        ...
        >
          <span className={styles.discordText}>JOIN OUR DISCORD</span>
          <svg 
        ...
        <a
          href="https://instagram.com/4storychaos"
          target="_blank"
          rel="noopener noreferrer"
        ...
        <a
          href="https://www.youtube.com/channel/UC7gEqpwEFc8Dq9FQ6GTOEOg"
          target="_blank"
          rel="noopener noreferrer"
          className={styles.socialIconLink}
        >
      ...
      <footer className={styles.siteFooter}>
        <div className={styles.footerInner}>
          <div className={styles.footerSection}>
            <h4 className={styles.footerTitle}>Pages</h4>
        ...
        <div className={styles.footerBottom}>
          © {new Date().getFullYear()} 4Chaos. All rights reserved.
        </div>
      </footer>
    </>
  );
